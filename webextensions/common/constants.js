...
export const kCOMMAND_BROADCAST_TAB_TOOLTIP_TEXT = 'treestyletab:broadcast-tab-tooltip-text';
export const kCOMMAND_BROADCAST_TAB_AUTO_STICKY_STATE = 'treestyletab:broadcast-tab-auto-sticky-state';
